...
// SubjectInformation 모델과
// MajorInformation 모델 간의 1:N 관계 설정 

// MajorInformation.hasMany(SubjectInformation, {
//   foreignKey: "created_college",
//   sourceKey: "major_code",
// });

// MajorInformation.hasMany(SubjectInformation, {
//   foreignKey: "governed_college",
//   sourceKey: "major_code",
// });
...
Basket.belongsToMany(SubjectInformation, {
  through: "BasketSubject",
  as: "BasketSubjects",
});
SubjectInformation.belongsToMany(Basket, {
  through: "BasketSubject",
  as: "BasketSubjects",
});
